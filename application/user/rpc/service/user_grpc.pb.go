...
type UserClient interface {
	...
	FindByMobile(ctx context.Context, in *FindByMobileRequest, opts ...grpc.CallOption) (*FindByIdResponse, error)
...
func (c *userClient) FindByMobile(ctx context.Context, in *FindByMobileRequest, opts ...grpc.CallOption) (*FindByIdResponse, error) {
	out := new(FindByIdResponse)
...
type UserServer interface {
	...
	FindByMobile(context.Context, *FindByMobileRequest) (*FindByIdResponse, error)
...
func (UnimplementedUserServer) FindByMobile(context.Context, *FindByMobileRequest) (*FindByIdResponse, error) {
